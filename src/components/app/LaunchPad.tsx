...
export function LaunchPad() {
  ...
  return (
    <div className='flex flex-col items-center justify-center w-full'>
      <Link href='/playground' onClick={() => trackEvent('launch', {'app': "playground"})} target='_blank' className="launch-btn px-4 py-2 font-bold hover:scale-105 transition-transform duration-300 w-auto text-center text-xl rounded-lg">
