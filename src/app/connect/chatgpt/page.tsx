...
export const metadata: Metadata = {
  title: 'Integrate ChatGPT with the productivity apps',
  description: "The only ChatGPT action you need. Connect ChatGPT with the tools you use daily through our no-code, secure integration hub.",
};
      ...
      <main className="flex-1 flex flex-col">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 px-4 sm:px-8 py-8 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col justify-center text-left space-y-4 lg:space-y-6">
            <h1 className="text-3xl lg:text-4xl font-bold">The only ChatGPT action<br/>you need</h1>
            <h2 className="text-lg lg:text-xl leading-snug">
              <span className="bg-yellow-100">Connect ChatGPT with the tools you use daily</span><br/>through our 
