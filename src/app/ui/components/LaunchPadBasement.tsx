...
export  function LaunchPadBasement() {
  ...
  return (
    ...
    <Link href='/connect/claude/guide' className="app-link" onClick={() => trackEvent('launchClaude')}>
      <Image src='/images/apps/claude.svg' width={20} height={20} alt="Claude"/>
      <span>Connect to Claude Desktop</span>
    </Link>
    <span className="text-sm font-medium text-gray-500">or</span>
    <Link href='/connect/mcp-server/guide' className="app-link" onClick={() => trackEvent('launchMCP')}>
