        ...
        <div className="bg-white border border-gray-200 rounded-lg p-4 sm:p-6">
          ...
          <div className="space-y-3">
            <div className="bg-gray-50 p-3 rounded-md">
              <code className="text-xs sm:text-sm break-words">&quot;Create a new task in my Asana project for the marketing campaign&quot;</code>
            </div>
            <div className="bg-gray-50 p-3 rounded-md">
              <code className="text-xs sm:text-sm break-words">&quot;Send a Slack message to the #team channel about today&apos;s standup&quot;</code>
            </div>
            <div className="bg-gray-50 p-3 rounded-md">
              <code className="text-xs sm:text-sm break-words">&quot;Search my Google Drive for documents related to Q4 planning&quot;</code>
            </div>
          </div>
        </div>
